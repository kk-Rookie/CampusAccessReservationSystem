...
public class BaseDao {
    ...
    private static final String DB_URL = "jdbc:mysql://118.31.165.159:3306/xsz_m";
    private static final String USER = "xsz_m";
    private static final String PASS = "@Xsz041211";
