...
<c:set var="pageTitle" value="部门详情" />
    ...
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/admin/department/list">部门管理</a></li>
                ...
                <div class="col-auto">
                    <a href="${pageContext.request.contextPath}/admin/department/list" class="btn btn-gradient-primary">
                        <i class="fas fa-arrow-left me-2"></i>返回列表
                    </a>
                    <a href="${pageContext.request.contextPath}/admin/department/edit/${department.deptId}" class="btn btn-gradient-success" target="_blank">
                        <i class="fas fa-edit me-2"></i>编辑部门
                    </a>
                </div>
            </div>
        </div>
        ...
        <c:if test="${not empty department}">
            ...
            <div class="card-custom">
                <h4 class="mb-4" style="color: #a78bfa; font-weight: 700;">
                    <i class="fas fa-building me-2"></i>部门概览
                </h4>
                ...
                <div class="overview-grid">
                    <div class="overview-item">
                        ...
                        <div class="overview-content">
                            <div class="overview-label">部门ID</div>
                            <div class="overview-value">#${department.deptId}</div>
                        </div>
                    </div>
                    <div class="overview-item">
                        <div class="overview-icon">
                        ...
                        <div class="overview-content">
                            ...
                            <div class="overview-value">${department.deptName}</div>
                        </div>
                    </div>
                    <div class="overview-item">
                        <div class="overview-icon">
                        ...
                        <div class="overview-content">
                            <div class="overview-label">部门代码</div>
                            <div class="overview-value">
                                <c:choose>
                                    <c:when test="${not empty department.departmentCode}">${department.departmentCode}</c:when>
            ...
            <div class="card-custom">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="detail-label">部门代码</div>
                ...
                <c:if test="${not empty department.description}">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="detail-label">部门描述</div>
